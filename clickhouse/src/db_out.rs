...
use crate::{balances::process_balances, erc20_contracts::process_erc20_contracts};

#[substreams::handlers::map]
pub fn db_out(mut clock: Clock, erc20_balances: EventsBalances, native_balances: EventsBalances) -> Result<DatabaseChanges, Error> {
    ...
    process_erc20_contracts(&mut tables, &clock, events, index);
